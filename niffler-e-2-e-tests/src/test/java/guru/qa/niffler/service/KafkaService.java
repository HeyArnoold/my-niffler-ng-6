...
public class KafkaService implements Runnable {
    ...
    static {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "autotest");
    ...
    public static UserJson getUser(String username) throws InterruptedException {
        return store.get(username, 15000L);
    }
        ...
        try {
            ...
            while (isRun.get()) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    String userAsStr = record.value();
                    UserJson userJson = om.readValue(userAsStr, UserJson.class);
